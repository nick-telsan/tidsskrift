...
export const Welcome = () => (
  <StandardArticle>
    ...
    <h3>The projects</h3>
    <p>I've always got a few things I'm working on. Yesterday at work, we had a demo of Svelte, and that was pretty cool. However, I was fixated on something else. Another developer posted a link that led me to <ArticleAchor href='https://notes.andymatuschak.org/z21cgR9K3UcQ5a7yPsj2RUim3oM2TzdBByZu'>this post</ArticleAchor>. Combined with learning about new tech, I set out to build this site and set up a somewhat lofty set of goals. Most of those goals can stay in my notes. This isn't the place to keep track of everything going on in my head. This is a place to talk about what I'm actually working on... so...</p>
    <ul>
      <li>
        <em>The Garage</em>
