...
export const About = () => {
  return (
    <ArticleContainer>
      ...
      />
      <p>
        I recently ran across the idea of <a href='https://notes.andymatuschak.org/z21cgR9K3UcQ5a7yPsj2RUim3oM2TzdBByZu'>working with the garage door open</a>. One of my colleauges posted another link to Andy's notes, and I really liked the idea.
      </p>
      <p>
